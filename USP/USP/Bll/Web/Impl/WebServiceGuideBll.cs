...
{
    public class WebServiceGuideBll : IWebServiceGuideBll
    {

        IWebServiceGuideDal dal;

        public WebServiceGuideBll(IWebServiceGuideDal dal)
        {
            this.dal = dal;
        ...
        public List<SelectOption> GetWebServiceGuideList(long id)
        {
        ...
        public DataGrid<UP_ShowWebServiceGuide_Result> GetAll(int? pageIndex, int? pageSize, string whereStr, string strOrder, string strOrderType)
        {
            DataGrid<UP_ShowWebServiceGuide_Result> result = new DataGrid<UP_ShowWebServiceGuide_Result>();
