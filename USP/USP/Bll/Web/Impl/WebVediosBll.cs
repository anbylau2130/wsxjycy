...
namespace USP.Bll.Web.Impl
{
    ...
    public class WebVediosBll : IWebVediosBll
    {

        IWebVediosDal dal;

        public WebVediosBll(IWebVediosDal dal)
        {
            this.dal = dal;
        ...
        public List<SelectOption> GetWebVediosList(long id)
        {
        ...
        public DataGrid<UP_ShowWebVedios_Result> GetAll(int? pageIndex, int? pageSize, string whereStr, string strOrder, string strOrderType)
        {
            DataGrid<UP_ShowWebVedios_Result> result = new DataGrid<UP_ShowWebVedios_Result>();
