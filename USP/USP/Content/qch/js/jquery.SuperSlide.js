	...
	$.fn.slide=function(options){
		...
		return this.each(function() {
			...
			switch(opts.effect)
			{
				...
				case "left": conBox.wrap('<div class="tempWrap" style="overflow:hidden; position:relative; ></div>').css( { "width":conBoxSize*slideW,"position":"relative","overflow":"hidden","padding":"0","margin":"0"}).children().css( {"float":"left","width":selfW} ); break;
				case "leftLoop":
				case "leftMarquee":
