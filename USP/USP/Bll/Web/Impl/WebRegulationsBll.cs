...
namespace USP.Bll.Web.Impl
{
    ...
    public class WebRegulationsBll : IWebRegulationsBll
    {

        IWebRegulationsDal dal;

        public WebRegulationsBll(IWebRegulationsDal dal)
        {
            this.dal = dal;
        }
        ...
        public AjaxResult Add(WebRegulations model)
        {
            AjaxResult result = new AjaxResult();
        ...
        public AjaxResult Edit(WebRegulations model, long @operator)
        {
            AjaxResult result = new AjaxResult();
        ...
        public List<SelectOption> GetWebRegulationsList(long id)
        {
        ...
        public DataGrid<UP_ShowWebRegulations_Result> GetAll(int? pageIndex, int? pageSize, string whereStr, string strOrder, string strOrderType)
        {
            DataGrid<UP_ShowWebRegulations_Result> result = new DataGrid<UP_ShowWebRegulations_Result>();
